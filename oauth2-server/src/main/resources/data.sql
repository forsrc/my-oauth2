...
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES  ('forsrc',   'forsrc,oauth_server,api,resource,ui', '$2a$10$Smc1lKpNSr/MeX1ZTt0GVu0b6LzlbOBp8Lzy9JfriAb1Xp8rVBMsm', 'forsrc,oauth_server,api,resource,tcc,user,ui,read,write', 'authorization_code,client_credentials,refresh_token,password,implicit', null, null, 36000, 36000, null, true);
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES  ('ui',       'forsrc,oauth_server,api,resource,ui', '$2a$10$Smc1lKpNSr/MeX1ZTt0GVu0b6LzlbOBp8Lzy9JfriAb1Xp8rVBMsm', 'forsrc,oauth_server,api,resource,tcc,user,ui,read,write', 'authorization_code,client_credentials,refresh_token,password,implicit', 'https://my-oauth2:22000/oauth2-client/login/oauth2/code/my-oauth2, https://my-oauth2:22000/oauth2-client/login', null, 36000, 36000, null, true);
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES  ('resource', 'forsrc,oauth_server,api,resource,ui', '$2a$10$Smc1lKpNSr/MeX1ZTt0GVu0b6LzlbOBp8Lzy9JfriAb1Xp8rVBMsm', 'forsrc,oauth_server,api,resource,tcc,user,ui,read,write', 'authorization_code,client_credentials,refresh_token,password,implicit', null, null, 36000, 36000, null, true);
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES  ('api',      'forsrc,oauth_server,api,resource,ui', '$2a$10$Smc1lKpNSr/MeX1ZTt0GVu0b6LzlbOBp8Lzy9JfriAb1Xp8rVBMsm', 'forsrc,oauth_server,api,resource,tcc,user,ui,read,write', 'authorization_code,client_credentials,refresh_token,password,implicit', null, null, 36000, 36000, null, true);
